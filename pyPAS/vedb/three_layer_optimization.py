...
class ThreeBulkDiffusionLengthOptimization:
    ...
    def make_sample(self, eff_surface_capture_rate, eff_rate_0, eff_rate_1, eff_rate_2):
        """
        ...
        return Sample([layer_0, layer_1, layer_2], eff_surface_capture_rate)
    ...
    def s_parameter_calculation(self, energies, eff_surface_capture_rate, eff_rate_0, eff_rate_1, eff_rate_2):
        """
        ...
        """
        sample = self.make_sample(eff_surface_capture_rate, eff_rate_0, eff_rate_1, eff_rate_2)
    ...
    def optimize_diffusion_length(self, bounds=None):
        ...
        effective_rate_2 = np.array(list(layer_material_1.rates.values())).sum() / layer_material_2.diffusion
        ...
        if bounds is None:
            ...
            if bounds[1][0] != 0 and bounds[1][1] != 0 and bounds[1][2] != 0 and bounds[1][3] != 0:
        ...
        effective_rate_fit_1 = ufloat(parm[3], cov[3, 3] ** 0.5)
