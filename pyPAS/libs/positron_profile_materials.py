...
def gosh_material_parameters():
    """
    Function to get the parameters for the positron implementation profile fit in various materials.
     The fit is Gosh fit which is described in [1]
    -------
    pd.DataFrame
    The parameters of Gosh fit for the positrons implementation profile in various materials
...
def makhov_material_parameters():
    ...
    -------
    pd.DataFrame
    The parameters of Makhov fit for the positrons implementation profile in various materials
    Reference
    ---------
