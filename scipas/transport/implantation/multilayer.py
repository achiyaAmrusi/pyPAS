...
from scipas.transport.implantation.utils import  get_layer_indices
from scipas.transport.implantation.profiles import ghosh_profile, makhov_profile
...
def multilayer_implantation_profile(positron_energy: float, depth_vector: np.ndarray,
    ...
    >>> import numpy as np
    >>> from scipas.transport import makhov_material_parameters, makhov_profile, multilayer_implantation_profile
